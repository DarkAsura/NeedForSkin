...
@section('content')
    <div class="container text-center">
        <div class="card col" style="width 18 rem;">
                ...
                <div class="card-body">
                    <img src="{{$gameAccount->image}}" class="card-img-top" alt="..." style="height: auto; width: auto; max-width: 300px; max-height: 300px;margin-left: auto;
                    margin-right: auto;">
                    ...
                    <p class="card-text">Price: {{$gameAccount->price}}</p>
