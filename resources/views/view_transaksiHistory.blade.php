    ...
    <div class="container text-center">
        <div class="card col" style="width 18 rem;">
            ...
            <div class="card-body">
                ...
                <img src="{{$transaksi->image}}" class="card-img-top" alt="..." style="height: auto; width: auto; max-width: 300px; max-height: 300px;margin-left: auto;
                margin-right: auto;">
                ...
                <p class="card-text">Buy From User ID: {{$transaksi->PrevOwner}}</p>
                <p class="card-text">Owner User ID: {{$transaksi->AccountOwner}}</p>
            </div>
            @endforeach
        </div>
    </div>
